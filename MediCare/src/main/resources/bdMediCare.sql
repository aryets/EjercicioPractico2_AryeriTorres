...
CREATE USER 'medicare_user'@'localhost' IDENTIFIED BY 'medicare_pass';
GRANT ALL PRIVILEGES ON medicare.* TO 'medicare_user'@'localhost';
FLUSH PRIVILEGES;
...
('Carlos Gomez', 'Cardiología', '2026-05-10', 45000.0, TRUE),
('Ana Martínez', 'Dermatologia', '2026-06-15', 35000.0, TRUE);
